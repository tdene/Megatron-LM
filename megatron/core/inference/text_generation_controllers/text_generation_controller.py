...
class TextGenerationController:
    ...
    async def async_generate_output_tokens_dynamic_batch(
        ...
        Args:
            ...
            loop (Optional[asyncio.AbstractEventLoop]): Event loop for GPU synchronization.
        ...
        # once the forward pass completes.
        # BASELINE: uses call_soon_threadsafe (back of queue).
        gpu_done.record()
